...
# Shared hierarchy losses; AdaptiveLoss above retains the official API.
import sys
from pathlib import Path
_ROOT = Path(__file__).resolve().parents[3]
if str(_ROOT) not in sys.path:
    sys.path.insert(0, str(_ROOT))
from hyperseg_h.losses import HierarchyLoss, containment_loss, geometric_loss, sandwich_loss
