...
> **[中文版](README_zh.md)** | English README
...
We extract **hyperbolic radius** $r$ as a geometric proxy for segmentation granularity, then map it to attention sharpness via $\tau(r)$.
...
**This is an experimental research codebase.** Memory optimization and stability fixes are ongoing.
