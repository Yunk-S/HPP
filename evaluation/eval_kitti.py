...
from hpp_sam.utils.part_benchmark_metrics import compute_benchmark_from_epoch_ious, print_benchmark_metric_help
...
def main():
    ...
    with torch.no_grad():
        ...
        epoch_ious_dict = {i: [float(total_ious[i])] for i in range(len(total_ious))}
        bench = compute_benchmark_from_epoch_ious(epoch_ious_dict)
        print("Point-SAM / PartNeXt-style benchmark:", bench)
